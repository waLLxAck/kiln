...
**[Website](https://wallxack.github.io/kiln/)** · **Download: [Windows](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/Kiln.Setup.0.19.0.exe) · [macOS](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/Kiln-0.19.0-arm64.dmg) · [Linux](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/Kiln-0.19.0-x86_64.AppImage)** · [All releases](https://github.com/waLLxAck/kiln/releases) · [Report an issue](https://github.com/waLLxAck/kiln/issues) · **[❤️ Sponsor](https://ko-fi.com/wallxack)**
...
Kiln 0.19.0 is on the [releases page](https://github.com/waLLxAck/kiln/releases), with earlier versions, release notes and `SHA256SUMS.txt`. See [what changed in 0.19.0](docs/releases/0.19.0.md).

| Platform | File | Status |
| --- | --- | --- |
| Windows (x64) | [`Kiln.Setup.0.19.0.exe`](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/Kiln.Setup.0.19.0.exe) | Supported |
| macOS, Apple silicon | [`Kiln-0.19.0-arm64.dmg`](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/Kiln-0.19.0-arm64.dmg) (or [`.zip`](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/Kiln-0.19.0-arm64.zip)) | New, untested |
| macOS, Intel | [`Kiln-0.19.0-x64.dmg`](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/Kiln-0.19.0-x64.dmg) (or [`.zip`](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/Kiln-0.19.0-x64.zip)) | New, untested |
| Linux (x64) | [`Kiln-0.19.0-x86_64.AppImage`](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/Kiln-0.19.0-x86_64.AppImage) or [`kiln_0.19.0_amd64.deb`](https://github.com/waLLxAck/kiln/releases/download/v0.19.0/kiln_0.19.0_amd64.deb) | New, untested |

The macOS and Linux builds have only been started on CI runners, not used on real machines yet. Please [report what breaks](https://github.com/waLLxAck/kiln/issues), or [build from source](#build-from-source).
...
- **Linux:** `chmod +x Kiln-0.19.0-x86_64.AppImage` and run it (needs FUSE 2). If it exits with a sandbox error, start it with `--no-sandbox`. Or install the package with `sudo apt install ./kiln_0.19.0_amd64.deb`.
