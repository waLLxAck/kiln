...
Kiln 0.18.2 is on the [releases page](https://github.com/waLLxAck/kiln/releases), with earlier versions, release notes and `SHA256SUMS.txt`. See [what changed in 0.18.2](docs/releases/0.18.2.md).
...
- **Linux:** `chmod +x Kiln-0.18.2-x86_64.AppImage` and run it (needs FUSE 2). If it exits with a sandbox error, start it with `--no-sandbox`. Or install the package with `sudo apt install ./kiln_0.18.2_amd64.deb`.
