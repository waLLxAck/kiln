...
export default function App() {
  ...
  useEffect(() => {
    ...
    const available = snapshot.items.some(i => (section === 'trash' ? Boolean(i.deletedAt) : !i.deletedAt) && (section === 'archive' ? hidden.includes(i.status) : section === 'trash' || !hidden.includes(i.status)) && (!collection || i.collection === collection) && inTab(i, tab));
